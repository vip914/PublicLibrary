...
namespace PublicLibrary.Web.Controllers
{
    public class UsersController : Controller
    {
        ...
        private UserRepository db1 = new UserRepository(MyConnectoinString);

        private string GetConnectoinString()
        {
        ...
        public ActionResult Details(int? id)
        {
            ...
            User user = db1.GetUser(id.GetValueOrDefault());//db.Users.Find(id);
            if (user == null)
            {
                return HttpNotFound();
            }
